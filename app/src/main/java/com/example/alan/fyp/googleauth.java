...
/**
 * Created by wadealanchan on 10/9/2017.
 */
...
public class googleauth extends BaseActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_googlesignin);


        findViewById(R.id.btn_googlesignin).setOnClickListener(this);
        findViewById(R.id.btn_googlesignout).setOnClickListener(this);
    ...
    private void updateUI(FirebaseUser currentUser) {
        hideProgressDialog();
        if (currentUser != null) {
            Toast.makeText(googleauth.this, currentUser.getEmail(),
                    Toast.LENGTH_SHORT).show();

            findViewById(R.id.btn_googlesignin).setVisibility(View.GONE);
            findViewById(R.id.btn_googlesignout).setVisibility(View.VISIBLE);

        } else {

            findViewById(R.id.btn_googlesignin).setVisibility(View.VISIBLE);
            findViewById(R.id.btn_googlesignout).setVisibility(View.GONE);
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.btn_googlesignin) {
            signIn();
        } else if (i == R.id.btn_googlesignout) {
            signOut();
        }
